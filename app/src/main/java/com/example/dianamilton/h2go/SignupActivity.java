...
public class SignupActivity extends AppCompatActivity {
     ...
     * Defines textboxes made in xml file
     * Signup button calls up signup method
     * Login link calls up login screen
     ...
     * by defining intent
     * sets result to ok and sends to main activity
     */
     ...
     * @return true if email and passcode follow certain criteria
     */
