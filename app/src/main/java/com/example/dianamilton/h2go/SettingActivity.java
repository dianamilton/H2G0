...
public class SettingActivity extends AppCompatActivity {
    ...
    private  SettingActivity myself;

    /**
     * Layout = activity_setting
     * AccountInfo button sends to useractivitylist
     * Passcode button sends to passcodeactivity
     * Home button sends to mainactivity
     * Delete button sends to login activity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        _accountInfoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d("APP", "abuout to make the intent");
                Intent intent = new Intent(/*getApplicationContext()*/myself, UserActivityList.class);
                Log.d("APP", "about to launch activity");
