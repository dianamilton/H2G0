...
public class AccountInfoActivity extends AppCompatActivity {
    ...
    /**
     * defines text fields made in layout xml file
     * Save button on click sends to userActivityList class, uses User object setters to save information
     * and print it in listview
     * Cancel button on click returns to MainActivity
